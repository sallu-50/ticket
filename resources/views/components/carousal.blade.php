<div id="carousel-indicators-dot" class="carousel slide carousel-fade " data-bs-ride="carousel">
    ...
    <div class="carousel-inner" style="height: 400px">
        <div class="carousel-item active">
            <img class="d-block w-100" alt="" src="https://picsum.photos/1000/300?text=1" />
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" alt="" src="https://picsum.photos/1000/300?text=2" />
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" alt="" src="https://picsum.photos/1000/300?text=3" />
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" alt="" src="https://picsum.photos/1000/300?text=4" />
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" alt="" src="https://picsum.photos/1000/300?text=5" />
        </div>
    </div>
</div>
